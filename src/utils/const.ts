...
const MAPBOX_TOKEN =
  ...
  'pk.eyJ1IjoibWFnaXNrIiwiYSI6ImNtanMxMGc5MDAyZmozanM0MDEwajc0cmYifQ.V-VzqkjgTxLGgJBCy4ov9A';
...
const EVENING_RUN_TITLE = IS_CHINESE ? '夜晚跑步' : 'Evening Run';
...
const nike = 'rgba(254, 254, 70, 1)'; // if you want to change the main color, modify this value in src/styles/variables.scss
